    ...
    <div onClick={() => props.history.push(`/task/${data.id}`)} className="flex w-full sm:flex-row flex-col sm:ml-0 sm:mr-0 ml-auto mr-6 items-center justify-between rounded shadow-lg cursor-pointer">
      <div className="flex flex-col p-6">
        ...
        <div className="flex sm:flex-row flex-col items-center">
          <span style={{fontFamily: 'OpenSans, Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal', fontSize: '12px', color: '#738f93', marginRight: '0.25rem'}}>Difficulty: </span>
          ...
          <span style={{fontFamily: 'OpenSans, Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal', fontSize: '12px', color: '#738f93', marginRight: '0.25rem'}}>Category: </span>
          ...
          <span style={{fontFamily: 'OpenSans, Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal', fontSize: '12px', color: '#738f93'}}>Solved Count: {data.solvedCount}</span>
        </div>
      </div>
